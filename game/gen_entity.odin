// Generated by build/entities.odin
...
remove_camera_component :: proc(e : Entity_Handle) {
	ent := get_entity(e)
	if ent == nil do panic("Removing camera component from non existent entity")
...
remove_transform_component :: proc(e : Entity_Handle) {
	ent := get_entity(e)
	if ent == nil do panic("Removing transform component from non existent entity")
...
remove_control_component :: proc(e : Entity_Handle) {
	ent := get_entity(e)
	if ent == nil do panic("Removing control component from non existent entity")
...
remove_target_component :: proc(e : Entity_Handle) {
	ent := get_entity(e)
	if ent == nil do panic("Removing target component from non existent entity")
